...
namespace KnijgoMenjava.Migrations
{
    ...
    [Migration("20251211153653_izboljsanPodatkovniModel")]
    partial class izboljsanPodatkovniModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Kategorija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Knjiga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DatumDodajanja")
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Ocena", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Rezervacija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Uporabnik", b =>
                {
            ...
            modelBuilder.Entity("KnjigoMenjava.Models.Knjiga", b =>
                {
                    b.HasOne("KnjigoMenjava.Models.Kategorija", "Kategorija")
                        .WithMany("Knjige")
                        .HasForeignKey("KategorijaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KnjigoMenjava.Models.Uporabnik", "Lastnik")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KnjigoMenjava.Models.Uporabnik", null)
                        .WithMany()
